  ...
  return (
    <div className="mb-4 mt-4 md:mt-0 rounded-lg overflow-hidden ">
      ...
      <div className="md:p-4 ">
        ...
        <div className="flex justify-center items-end gap-2 align-middle md:gap-8  ">
          <div className="text-center">
            <div className="text-xs text-white">
              {homeTeam} {selectedLine}
            </div>
          ...
          <div className="text-center flex flex-col justify-center align-middle items-center">
            <div className="text-xs text-white max-w-20 text-center  ">
              {awayTeam} {-selectedLine}
            </div>
            <div className="bg-[#132C42] w-[94px] text-white p-2 rounded mt-1">
