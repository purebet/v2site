...
<div className='border-[1px] border-[#ffffff] opacity-15 border-solid'></div>
  {getMarketData('FT') && <FullTime title="Full Time Result" data={getMarketData('FT')} showLiquidity homeTeam={eventDetails.homeTeam} awayTeam={eventDetails.awayTeam} />}
 <div className='border-[1px] border-[#ffffff] opacity-15 border-solid'></div>
  {getMarketData('DC') && <BettingMarket title="Double Chance" data={getMarketData('DC')} showLiquidity />}
  <div className='border-[1px] border-[#ffffff] opacity-15 border-solid'></div>

            {getMarketData('BTTS') && <BTTS title="Both Teams to Score" data={getMarketData('BTTS')} showLiquidity />}
            <div className='border-[1px] border-[#ffffff] opacity-15 border-solid'></div>

            {getMarketData('AH') && <AsianHandicap title="Asian Handicap" data={getMarketData('AH')} homeTeam={eventDetails.homeTeam} awayTeam={eventDetails.awayTeam} showLiquidity />}
            <div className='border-[1px] border-[#ffffff] opacity-15 border-solid'></div>

            {getMarketData('OU') && <OU title="Over / Under" data={getMarketData('OU')} homeTeam={eventDetails.homeTeam} awayTeam={eventDetails.awayTeam} showLiquidity />}
            <div className='border-[1px] border-[#ffffff] opacity-15 border-solid'></div>

            {getComplexMarketData('FT+BTTS') && <ResultandBothTeamstoScore title="Result and Both Teams to Score" data={getComplexMarketData('FT+BTTS')} homeTeam={eventDetails.homeTeam} awayTeam={eventDetails.awayTeam} showLiquidity />}
            <div className='border-[1px] border-[#ffffff] opacity-15 border-solid'></div>

            {getComplexMarketData('FT+OU') && <ResultandTotal title="Result and Total" data={getComplexMarketData('FT+OU')} showLiquidity />}
            <div className='border-[1px] border-[#ffffff] opacity-15 border-solid'></div>

            {getComplexMarketData('BTTS+OU') && <BothTeamstoScoreandTotal title="Both Teams to Score and Total" data={getComplexMarketData('BTTS+OU')} showLiquidity homeTeam={eventDetails.homeTeam} awayTeam={eventDetails.awayTeam}  />}
            <div className='border-[1px] border-[#ffffff] opacity-15 border-solid'></div>

            {getComplexMarketData('HTFT') && <HalfTimeFullTime title="Half-time/Full-time" data={getComplexMarketData('HTFT')} showLiquidity />}
            <div className='border-[1px] border-[#ffffff] opacity-15 border-solid'></div>
            {getMarketData('TOU') && <TeamOverUnder  title="Team Over/Under"
...
<div className="relative z-10 box-border p-1.5 pt-0 max-h-[77vh] overflow-y-scroll rounded-[16px] sm:rounded-[24px]">
{getMarketData('ML' , '2') && <BettingMarket title="Money Line" data={getMarketData('ML' , '2')} showLiquidity />}


<div className='border-[1px] border-[#ffffff] opacity-15 border-solid'></div>
  {getMarketData('FT' , '2') && <FullTime title="Full Time Result" data={getMarketData('FT' , '2')} showLiquidity homeTeam={eventDetails.homeTeam} awayTeam={eventDetails.awayTeam} />}
 <div className='border-[1px] border-[#ffffff] opacity-15 border-solid'></div>
  {getMarketData('DC' , '2') && <BettingMarket title="Double Chance" data={getMarketData('DC', '2')} showLiquidity />}
  <div className='border-[1px] border-[#ffffff] opacity-15 border-solid'></div>

            {getMarketData('BTTS' , '2') && <BTTS title="Both Teams to Score" data={getMarketData('BTTS', '2')} showLiquidity />}
            <div className='border-[1px] border-[#ffffff] opacity-15 border-solid'></div>

            {getMarketData('AH' , '2') && <AsianHandicap title="Asian Handicap" data={getMarketData('AH', '2')} homeTeam={eventDetails.homeTeam} awayTeam={eventDetails.awayTeam} showLiquidity />}
            <div className='border-[1px] border-[#ffffff] opacity-15 border-solid'></div>

            {getMarketData('OU', '2') && <OU title="Over / Under" data={getMarketData('OU', '2')} homeTeam={eventDetails.homeTeam} awayTeam={eventDetails.awayTeam} showLiquidity />}
            <div className='border-[1px] border-[#ffffff] opacity-15 border-solid'></div>

            {getComplexMarketData('FT+BTTS', '2') && <ResultandBothTeamstoScore title="Result and Both Teams to Score" data={getComplexMarketData('FT+BTTS', '2')} homeTeam={eventDetails.homeTeam} awayTeam={eventDetails.awayTeam} showLiquidity />}
            <div className='border-[1px] border-[#ffffff] opacity-15 border-solid'></div>

            {getComplexMarketData('FT+OU', '2') && <ResultandTotal title="Result and Total" data={getComplexMarketData('FT+OU', '2')} showLiquidity />}
            <div className='border-[1px] border-[#ffffff] opacity-15 border-solid'></div>

            {getComplexMarketData('BTTS+OU', '2') && <BothTeamstoScoreandTotal title="Both Teams to Score and Total" data={getComplexMarketData('BTTS+OU', '2')} showLiquidity homeTeam={eventDetails.homeTeam} awayTeam={eventDetails.awayTeam}  />}
            <div className='border-[1px] border-[#ffffff] opacity-15 border-solid'></div>

            {getComplexMarketData('HTFT', '2') && <HalfTimeFullTime title="Half-time/Full-time" data={getComplexMarketData('HTFT', '2')} showLiquidity />}
            {/* <div className='border-[1px] border-[#ffffff] opacity-15 border-solid'></div> */}
            {getMarketData('TOU', '2') && <TeamOverUnder  title="Team Over/Under"
  ...
  eventDetails={{
    ...
    <div className='border-[1px] border-[#ffffff] opacity-15 border-solid'></div>
            {getComplexMarketData('CS', '2') && <BettingMarket title="Correct Score" data={getComplexMarketData('CS', '2')} showLiquidity />}
  ...
  return (
    <div className="">
      ...
      className="flex overflow-x-auto w-[90%] md:w-[80%] justify-start md:mt-5 p-4 gap-2 z-[100]">
